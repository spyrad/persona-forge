...
- [x] 3.1 Build grün: `npm run build`
- [x] 3.2 Lint grün: `npm run lint`
- [x] 3.3 Unit-Tests grün: `npm run test`
...
- [ ] 4.1 Build grün: `npm run build`
- [ ] 4.2 Lint grün: `npm run lint`
- [ ] 4.3 Unit-Tests grün: `npm run test`
