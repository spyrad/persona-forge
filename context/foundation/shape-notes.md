...
checkpoint:
  ...
  gray_areas_resolved:
    - topic: "Pain-Kategorie"
      decision: "Fehlende Messbarkeit + Nachweis-/Compliance-Druck + Entscheidungslähmung"
    - topic: "Insight"
      decision: "Psychometrie statt Ad-hoc; Verteilung statt Punktwert; Persona als Erstklasse-Objekt"
    - topic: "Primäre Nutzer"
      decision: "Zwei Rollen: Modell-Evaluierer (AI/ML-Engineers) + Persona-Autoren"
    - topic: "Test-Scope-Tiefe"
      decision: "Psychometrie UND Persona-Treue-Validierung (Spec Abschnitt 7) von Anfang an"
    - topic: "Auth-Methode"
      decision: "E-Mail + Passwort"
    - topic: "Sichtbarkeit"
      decision: "Nach Socrates: zweistufig privat/global, Default global; gezieltes Teilen an Einzelne gestrichen (FR-004)"
    - topic: "Audit-Tiefe"
      decision: "Basis: Ersteller + Zeitstempel pro Objekt (kein separates Ereignis-Log im MVP)"
    - topic: "MVP-Schnitt"
      decision: "Mittelweg: voller Methodenkern + Vergleich in v1; Persona-Treue-Validierung als späterer Cycle (Non-Goal v1); ~6–8 Wochen"
    - topic: "Rollenmodell (Socrates)"
      decision: "v1 einrollig; Admin-Rolle (Nutzerverwaltung, globale Verwaltung) späterer Cycle, globale Objekte per Seed/Config"
    - topic: "Instrument-Scope (Socrates, später revidiert)"
      decision: "v1 ein Instrument: zunächst Mini-IPIP, dann auf OEJTS getauscht (MBTI-artige Typenausgabe, gemeinfrei). IPIP/Big-Five-Likert + voll deklarative Engine späterer Cycle. Offizieller MBTI = dauerhafter No-Go (Urheberrecht)."
    - topic: "Persona-Mutabilität (Socrates)"
      decision: "Personas immutable, Änderung = Kopie; keine Versionshistorie in v1"
  frs_drafted: 16
  quality_check_status: accepted
---

# Shape Notes: persona-forge
...
Acknowledged on 2026-06-09: ~6–8-Wochen-MVP (mvp_weeks: 7) erfordert durchgehaltene
Arbeit über mehrere Cycles; Nutzer hat den Aufwand bewusst akzeptiert (Mittelweg-Schnitt).
...
- **Last-Verträglichkeit.** Ein Lauf gegen einen ratenbegrenzten Endpunkt schließt
  erfolgreich ab, ohne den Endpunkt zu überlasten. (Gewählter Weg für v1: sequentielle
  Calls mit Backoff bei Drosselung — Umsetzungsdetail, downstream.)
