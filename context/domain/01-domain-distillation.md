...
| **Instrument-Definition** (`instruments/oejts.ts`, `types.ts` Instrument/Axis/Item)           | **CORE**                                    | Das offen lizenzierte, strukturierte Instrument (OEJTS, CC BY-NC-SA 4.0) IST der Insight gegenüber selbsterfundenen Prompts (`prd.md:38-39`). Ohne korrekte Achsen/Polung kein valides Scoring. |
